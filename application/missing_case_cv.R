...
index1 = intersect(which(survivalTrainMissing$missing_index ==0), which(death == 0))
index2 = intersect(which(survivalTrainMissing$missing_index ==0), which(death == 1))
...
result_wd = "real_case_2/missing_case/cv_multipleGamma30_b_0.5_a_4"
